...
public class Results extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        //Try-catch to go through line of the database.txt file to be added to a jTextArea
        try {
        ...
        System.out.println("");
        //Sets statistics to a jTextArea
        jTextArea3.setText("There are " + rat + " Rat players stored" + "\n" + "There are " + rabbit + " Rabbit players stored" + "\n" + "There are " + sheep + " Sheep players stored" + "\n" + "There are " + pig + " Pig players stored" + "\n" + "\n" + "There are " + animal.getCurrentPlayer() + " players active" + "\n" + "\n" + "Quickest set run was " + lowestSeconds + " seconds");
